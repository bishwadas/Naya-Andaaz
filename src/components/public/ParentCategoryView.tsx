              ...
              <div className="hidden lg:grid grid-cols-12 gap-8 items-start">
                  ...
                  {leftPosts.map((post) => {
                    ...
                    return (
                      <div key={post.id} className="flex flex-col group">
                        <Link href={`/${post.slug}`} className="block aspect-[16/9] w-full overflow-hidden bg-stone-100 mb-3">
                          <img
                ...
                {centerPost && (
                  <div className="col-span-6 flex flex-col group">
                    <Link href={`/${postSlug(centerPost)}`} className="block aspect-[16/9] w-full overflow-hidden bg-stone-100 mb-4">
                      <img
                ...
                {childPosts.slice(0, 4).map((post) => {
                  ...
                  return (
                    <div key={post.id} className="flex gap-4 items-center bg-white p-2 group">
                      <Link href={`/${post.slug}`} className="w-28 sm:w-36 aspect-[16/9] shrink-0 overflow-hidden bg-stone-100 block">
                        <img
                          src={post.featuredImage || 'https://images.unsplash.com/photo-1504711434969-e33886168f5c?auto=format&fit=crop&w=1200&q=80'}
                          alt={post.title}
                          width="1200"
