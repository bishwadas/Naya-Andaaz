...
export function PageEditor({
  ...
  const addBlock = (type: Block['type']) => {
    const newBlock: Block = {
      ...
      attrs:
        type === 'image'
          ? { url: 'https://images.unsplash.com/photo-1504711434969-e33886168f5c?w=1200&auto=format&fit=crop&q=80', alt: '', caption: '' }
          : type === 'button'
          ? { buttonText: 'Learn More', buttonUrl: '#', buttonStyle: 'primary', buttonAlign: 'left' }
          : {},
    };
            ...
            <div className="max-w-3xl w-full space-y-8 font-sans">
              ...
              {editMode === 'html' ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="sticky top-20 z-20 bg-stone-50/95 backdrop-blur-md border border-stone-200 rounded-xl p-2 shadow-sm flex flex-wrap items-center gap-1.5">
                    <button
                      type="button"
                      onClick={() => addBlock('heading-h2')}
                      className="px-2.5 py-1.5 bg-white hover:bg-stone-100 text-stone-700 text-xs font-semibold rounded-lg border border-stone-200 transition flex items-center gap-1"
                    >
                      <span className="font-bold font-serif text-pink-600">H2</span> Heading
                    </button>
                    <button
                      type="button"
                      ...
                      className="px-2.5 py-1.5 bg-white hover:bg-stone-100 text-stone-700 text-xs font-semibold rounded-lg border border-stone-200 transition flex items-center gap-1"
                    >
                      <span className="font-bold font-serif text-pink-600">H3</span> Subheading
                    </button>
                    <button
                      type="button"
                      ...
                      className="px-2.5 py-1.5 bg-white hover:bg-stone-100 text-stone-700 text-xs font-semibold rounded-lg border border-stone-200 transition flex items-center gap-1"
                    >
                      <FileText className="w-3.5 h-3.5 text-stone-500" /> Paragraph
                    </button>
                    <button
                      type="button"
                    ...
                    <button
                      ...
                      className="px-2.5 py-1.5 bg-white hover:bg-stone-100 text-stone-700 text-xs font-semibold rounded-lg border border-stone-200 transition flex items-center gap-1"
                    >
                      <List className="w-3.5 h-3.5 text-stone-500" /> Bullets
                    </button>
                    <button
                      type="button"
                      onClick={() => addBlock('list-number')}
                      className="px-2.5 py-1.5 bg-white hover:bg-stone-100 text-stone-700 text-xs font-semibold rounded-lg border border-stone-200 transition flex items-center gap-1"
                    >
                      <ListOrdered className="w-3.5 h-3.5 text-stone-500" /> Numbers
                    </button>
                    <button
                      type="button"
                    ...
                    <button
                      ...
                      className="px-2.5 py-1.5 bg-white hover:bg-stone-100 text-stone-700 text-xs font-semibold rounded-lg border border-stone-200 transition flex items-center gap-1"
                    >
                      <Layers className="w-3.5 h-3.5 text-stone-500" /> Button CTA
                    </button>
                  </div>
                  ...
                  <div className="space-y-4">
                    {blocks.map((block, index) => (
                      <div
                        key={block.id}
                        className="bg-white border border-stone-200 rounded-xl p-4 shadow-2xs space-y-3 group hover:border-pink-300 transition"
                      >
                        <div className="flex items-center justify-between border-b border-stone-100 pb-2">
                          <span className="text-[11px] font-mono font-bold uppercase tracking-wider text-pink-600 bg-pink-50 px-2 py-0.5 rounded">
                            {block.type.replace('-', ' ')}
                          </span>
                          ...
                          <div className="flex items-center gap-1 opacity-80 group-hover:opacity-100 transition">
                            ...
                            <button
                              ...
                              className="p-1 hover:bg-rose-50 rounded text-rose-600 ml-1"
                              title="Delete Block"
                            >
                        ...
                        {block.type === 'paragraph' && (
                          <textarea
                            ...
                            value={block.content}
                            onChange={(e) => updateBlockContent(block.id, e.target.value)}
                            placeholder="Write page content paragraph..."
