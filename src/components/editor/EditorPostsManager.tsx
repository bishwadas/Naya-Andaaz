...
export interface EditorPostsManagerProps {
  initialPosts?: Post[];
  categories?: Category[];
  users?: User[];
...
export const EditorPostsManager: React.FC<EditorPostsManagerProps> = ({
  initialPosts = [],
  categories = [],
  users = [],
  initialMode = 'all',
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-5">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#FFFDFC] border border-[#E5E0DA] rounded-2xl p-5 shadow-xs">
            ...
            <div className="flex items-center flex-wrap gap-2.5">
              ...
              <button
                type="button"
                onClick={() => router.push('/editor/posts/categories')}
                className="inline-flex items-center gap-1.5 px-3 py-2 bg-white border border-[#DDD6D0] hover:border-[#EC008C] hover:text-[#EC008C] text-[#6B625C] text-xs font-medium rounded-xl transition shadow-xs"
              >
              ...
              <div className="p-12 text-center space-y-4">
                ...
                <div>
                  {hasActiveFilters ? (
                    ...
                    <button
                      type="button"
                      onClick={() => router.push('/editor/posts/new')}
                ...
                <table className="w-full text-left text-xs border-collapse">
                  <thead>
                    <tr className="border-b border-[#E5E0DA] bg-[#FBF8F5] text-[#6B625C] font-mono text-[11px] uppercase tracking-wider">
                      ...
                      <th className="py-3.5 px-3 hidden lg:table-cell">Author</th>
                      <th
                        className="py-3.5 px-3 cursor-pointer select-none hover:text-[#171717]"
                        ...
                        >
                          ...
                          <td className="py-3 px-3 align-top space-y-1.5">
                            <div>
                              <button
                                type="button"
                                onClick={() => router.push(`/editor/posts/${post.id}/edit`)}
      ...
      {/* VIEW: Tags Manager (Preserved for full compatibility with /editor/posts/tags) */}
      {viewMode === 'tags' && (
        <div className="space-y-5">
