...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  if (!page) {
    return {
      title: 'Page Not Found — Sereia',
    };
  }
  return {
    title: page.seoTitle || `${page.title} — Sereia`,
    description: page.metaDescription || `Read ${page.title} on Sereia Digital Magazine.`,
    openGraph: {
    ...
    <div className="min-h-screen bg-stone-50 text-stone-900 font-sans antialiased">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        ...
        <article className="bg-white border border-stone-200 rounded-2xl p-8 sm:p-12 shadow-sm space-y-6">
          ...
          <div className="prose prose-stone prose-lg max-w-none font-serif text-stone-800 leading-relaxed space-y-4">
            {page.content ? (
